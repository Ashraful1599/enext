      ...
      >
        ...
        <div className="product text-center">
          <figure className="product-media">
            <a href="product.html">
              <Image
                src="/assets/images/demos/demo1/products/product2.jpg"
                alt="Blue Pinafore Denim Dress"
                width={280}
                height={315}
                style={{ backgroundColor: "#f2f3f5" }}
            ...
            <div className="product-label-group">
              <span className="product-label label-sale">25% off</span>
            </div>
            <div className="product-action-vertical">
              <a
                href="#"
        ...
        <div className="product text-center">
          <figure className="product-media">
            <a href="product.html">
              <Image
                src="/assets/images/demos/demo1/products/product3.jpg"
                alt="Blue Pinafore Denim Dress"
                width={280}
                height={315}
                style={{ backgroundColor: "#f2f3f5" }}
        ...
        <div className="product text-center">
          <figure className="product-media">
            <a href="product.html">
              <Image
                src="/assets/images/demos/demo1/products/product4.jpg"
                alt="Blue Pinafore Denim Dress"
                width={280}
                height={315}
                style={{ backgroundColor: "#f2f3f5" }}
